...
@Component({
  selector: 'app-master-agent-pdv-creditation-cc',
  templateUrl: './master-agent-pdv-creditation-cc.component.html',
  styleUrls: ['./master-agent-pdv-creditation-cc.component.css']
})
export class MasterAgentPdvCreditationCcComponent implements OnInit {
