...
@Component({
  selector: 'app-master-agent-pdv-update-caution',
  templateUrl: './master-agent-pdv-update-caution.component.html',
  styleUrls: ['./master-agent-pdv-update-caution.component.css']
})
export class MasterAgentPdvUpdateCautionComponent implements OnInit {
