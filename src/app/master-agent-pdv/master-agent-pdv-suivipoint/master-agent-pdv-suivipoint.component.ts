...
@Component({
  selector: 'app-master-agent-pdv-suivipoint',
  templateUrl: './master-agent-pdv-suivipoint.component.html',
  styleUrls: ['./master-agent-pdv-suivipoint.component.css']
})
export class MasterAgentPdvSuivipointComponent implements OnInit {
